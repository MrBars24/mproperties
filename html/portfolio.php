<?php include("includes/header.php"); ?>
		...
		<div class="row">
			<div class="small-12 medium-10 medium-push-1 columns portfolio">
				<div class="home-body-container ">
					<div class="row relative">
						<div class="medium-12 columns">
				          	...
				          	<div class="sub-title">
					      		<h3>10 Completed Investments</h3>
					      	</div>
		        		</div>
					</div>
								...
								<table class="hover responsive centered completed-investments">
								  ...
								  <tbody>
								    ...
								    <tr>
								     ...
								     <tr>
								      <td>Patterson Residences</td>
								      <td>$4,298,540</td>
								      <td>$2,182</td>
								      <td>9</td>
								      <td>$45,000</td>
								      <td class="txt-red">-0.1%</td>
								      <td>3%</td>
								      <td>$120,000</td>
								    </tr>
								     <tr>
								      <td>Ang Mo Residences</td>
								      <td>$2,077,000</td>
								      <td>$1,675</td>
								      <td>5</td>
								      <td>$25,000</td>
						...
						<div class="row no-margin summary-holder no-border">
								...
								<div class="row no-margin">
									<div class="medium-2 small-12 columns">
										<div class="item-center">
											<img src="images/insights-icon.png">
										</div>
									</div>
							...
							<div class="medium-6 small-12 columns">
								<div class="row no-margin">
									<div class="medium-2 small-12 columns">
										<div class="item-center">
											<img src="images/recommend-icon.png">
										</div>
									</div>
									<div class="medium-10 small-12 columns">
										<div class="">
		...
		<div class="small-12 medium-6 align-center reveal-modal" id="select_property_box" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog">
