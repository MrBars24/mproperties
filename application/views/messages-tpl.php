		...
		<div class="large-6 medium-6 small-6 columns text-right">
			<p class="message-bold float-right">1-20 of 50 messages
				<span class="message-pager">
					<a href="#" class="ml-20"><img src="<?php echo base_url('assets/frontend/images/pagi-left-arrow.png'); ?>" alt="" class="pagi-left"></a>
					<span class="mr-10"></span>
					<a href="#"><img src="<?php echo base_url('assets/frontend/images/pagi-right-arrow.png'); ?>" alt="" class="pagi-right"></a>
				</span>
			</p>
		</div>
	</div>
	...
	<div class="row border-image">
		<div class="messages-actions message unread">
			...
			<div class="ov-special-wrap">
				<div class="large-10 medium10 small-12 columns">
					<div class="sender">
						<img src="<?php echo base_url('assets/msg-user/tan-zi-wei.png'); ?>"> Tan Zi Wei
					</div>
					<div class="message-data">
	...
	<div class="row border-image">
		<div class="messages-actions message unread">
			...
			<div class="ov-special-wrap">
				<div class="large-10 medium10 small-12 columns">
					<div class="sender">
						<img src="<?php echo base_url('assets/msg-user/default-user.png'); ?>"> Larry Lim
					</div>
					<div class="message-data">
						<span class="bold">Conversation -</span> Lorem ipsum dolor sit amet, consectetur adipiscing elit tempor incididunt ut labore ....
					</div>
	...
	<div class="row border-image">
		<div class="messages-actions message unread">
			...
			<div class="ov-special-wrap">
				<div class="large-10 medium10 small-12 columns">
					<div class="sender">
						<img src="<?php echo base_url('assets/msg-user/richard-tan.png'); ?>"> Richard Tan
					</div>
					<div class="message-data">
						<span class="bold">Conversation -</span> Lorem ipsum dolor sit amet, consectetur adipiscing elit tempor incididunt ut labore ....
					</div>
