            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    <li>
                        ...
                        <a href="<?php echo site_url('/admin/property/lisitngs'); ?>">Properties</a>
                ...
                <div class="col-md-12">
                    <div class="portlet">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-grid"></i>Distribution
                            </div>                       
                        </div>
                    </div>
                </div>
    ...
    var handleProperty = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": base_url+"admin/Property/ajax/get_distribution_table", // ajax source
                },
                "order": [
                    [0, "desc"]
