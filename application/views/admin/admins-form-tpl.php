        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="<?=site_url('admin/admins')?>">Admins</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <li>
                        <?php if($admin_id == 0): ?>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-grid"></i>Admin
                            </div>
                        </div>
                        <div class="portlet-body form" id="country-container">
                            <?php echo form_open_multipart('admin/admins/form/'.$admin_id, array('class'=>'form-horizontal', 'id'=>'company_form')); ?>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="portlet light bordered">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                ...
                                                <span class="caption-subject bold font-yellow-casablanca uppercase"> Admin Login Details</span>
                                            </div>
                                        </div>
                                        <div class="portlet-body">
                                            ...
                                            <?php if ($admin_id == 0) { ?>
                                            <div class="form-group">
                                                <label class="control-label col-md-2">User Group<span
                                                        class="required">
                                                    * </span>
                                                </label>
                                                ...
                                                <div class="col-md-4">
                                                    <select name="user_group" id="user_group" class="form-control">
                                                        <?php foreach ($groups as $key => $value) {
                                                            $selected = '';
                                                            if (in_array($key, array($selected_group))) $selected = 'checked';?>
