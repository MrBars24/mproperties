...
function deleteUser(id)
{
    ...
    if (answer) {
        ...
        $.ajax({
            url: base_url + 'admin/promoters/ajax/user_delete',
            type: 'post',
            data: {
                "id": id,
            ...
            success: function (data) {
                ...
                location.replace(base_url + 'admin/promoters')
            }
        })
    }
    else {
    ...
    var handleUsers = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": base_url+"admin/promoters/ajax/get_all_users", // ajax source
                },
                "order": [
                    [0, "desc"]
