        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="<?=site_url('admin/account-managers')?>">Account Managers</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <li>
                        <?php if($user_id == 0): ?>
                            <a href="#">Add Account Manager</a>
                        <?php else: ?>
                            <a href="#">Edit Account Manager</a>
                        <?php endif; ?>
                        <i class="fa fa-angle-right"></i>
                    </li>
                </ul>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-grid"></i>Account Manager
                            </div>
                        </div>
                        <div class="portlet-body form" id="country-container">
                            <?php echo form_open_multipart('admin/account-managers/form/'.$user_id, array('class'=>'form-horizontal', 'id'=>'company_form')); ?>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="portlet light bordered">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                ...
                                                <span class="caption-subject bold font-yellow-casablanca uppercase"> Account Manager Details</span>
                                            </div>
                                        </div>
