            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    <li>
                        ...
                        <a href="<?php echo site_url('/admin/users'); ?>">Escrow Managers</a>
                ...
                <div class="col-md-12">
                    <div class="portlet">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-grid"></i>Escrow Managers
                            </div> 
                            <div class="actions">
                                <a href="<?php echo site_url('admin/escrow-managers/form/0');?>" class="btn default yellow-stripe">
                                <i class="fa fa-plus"></i>
                                <span class="hidden-480">
                                Add New Escrow Manager</span>
                                </a>                               
                            </div>                              
                        </div>
                    </div>
    ...
    var handleUsers = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": base_url+"admin/escrow-managers/ajax/get_all_users", // ajax source
                },
                "order": [
                    [0, "desc"]
