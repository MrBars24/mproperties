                ...
                <div class="col-md-12">
                    <div class="portlet">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-grid"></i>Users
                            </div> 
                            <div class="actions">
                                <a href="<?php echo site_url('admin/users/form/0');?>" class="btn default yellow-stripe">
                    ...
                    <div class="portlet-body">
                        <div class="table-container">
                            ...
                            <tr role="row" class="filter">
                                ...
                                <td>
                                    <input type="text" class="form-control form-filter input-sm" name="filter[both][phone]">
                                </td>
                                <td>
                                </td>
                                <td>
    ...
    var handleUsers = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": base_url+"admin/users/ajax/get_all_users", // ajax source
                },
                "order": [
                    [0, "desc"]
