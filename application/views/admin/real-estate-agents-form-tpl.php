        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="<?=site_url('admin/real-estate-agents')?>">Real Estate Agents</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <li>
                        <?php if($user_id == 0): ?>
                            <a href="#">Add Real Estate Agent</a>
                        <?php else: ?>
                            <a href="#">Edit Real Estate Agent</a>
                        <?php endif; ?>
                        <i class="fa fa-angle-right"></i>
                    </li>
                </ul>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light bordered">
                        ...
                        <div class="portlet-body form" id="country-container">
                            <?php echo form_open_multipart('admin/real-estate-agents/form/'.$user_id, array('class'=>'form-horizontal', 'id'=>'company_form')); ?>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="portlet light bordered">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                ...
                                                <span class="caption-subject bold font-yellow-casablanca uppercase"> Real Estate Agent Details</span>
                                            </div>
                                        </div>
