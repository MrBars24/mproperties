...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            <h3 class="page-title">KYC Manager</h3>
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="<?=site_url('admin/know-your-client')?>">KYC Managers</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <li>
                        <?php if($user_id == 0): ?>
                            <a href="#">Add KYC Manager</a>
                        <?php else: ?>
                            <a href="#">Edit KYC Manager</a>
                        <?php endif; ?>
                        <i class="fa fa-angle-right"></i>
                    </li>
                </ul>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-grid"></i>KYC Manager
                            </div>
                        </div>
                        <div class="portlet-body form" id="country-container">
                            <?php echo form_open_multipart('admin/know-your-client/form/'.$user_id, array('class'=>'form-horizontal', 'id'=>'company_form')); ?>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="portlet light bordered">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                ...
                                                <span class="caption-subject bold font-yellow-casablanca uppercase"> KYC Manager Details</span>
                                            </div>
                                        </div>
                                        <div class="portlet-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input required type="text" name="first_name" id="first_name" class="form-control" data-required="1" value="<?php echo $first_name; ?>" >
                                                </div>
                                            </div>                                        
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input required type="text" name="last_name" id="last_name" class="form-control" data-required="1" value="<?php echo $last_name; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input required type="text" name="email" id="email" class="form-control" data-required="1" value="<?php echo $email; ?>">
                                                </div>
                                            </div>                                            
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <?php else: ?>
                                                        ...
                                                        <img src="<?php echo site_url('uploads') . '/profile/' . $profile_photo; ?>" width="100%">
                                                        <br/><br/>
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <a href="<?php echo site_url('admin/know-your-client');?>" class="btn default">Cancel</a>
                                    </div>
                                </div>
                            </div>
                            </form>
