...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            <h3 class="page-title">Promoter Commissions</h3>
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    <li>
                        ...
                        <a href="<?php echo site_url('/admin/promoters'); ?>">Promoter Commissions</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <li>
                        <a href="#">Promoter Commissions</a>
                    </li>
                </ul>
            </div>
            <!-- END PAGE HEADER-->
                ...
                <div class="col-md-12">
                    <div class="portlet">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-grid"></i>Promoter Commissions
                            </div>
                            <!--div class="actions">
                    ...
                    <div class="portlet-body">
                        <div class="table-container">
                            ...
                            <tr role="row" class="heading">
                                <th width="15%">Promoter</th>
                                <th width="15%">Total Commissions</th>
                            </tr>
                            </thead>
                            <tbody>
                            </tbody>
    ...
    var handleUsers = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": base_url+"admin/promoters/ajax/get_all_promoter_commissions", // ajax source
                    "data": {
