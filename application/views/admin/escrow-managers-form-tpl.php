...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            <h3 class="page-title">Escrow Managers</h3>
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">Escrow Managers</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <li>
                        <?php if($user_id == 0): ?>
                            <a href="#">Add Escrow Manager</a>
                        <?php else: ?>
                            <a href="#">Edit Escrow Manager</a>
                        <?php endif; ?>
                        <i class="fa fa-angle-right"></i>
                    </li>
                </ul>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-grid"></i>Escrow Manager
                            </div>
                        </div>
                        <div class="portlet-body form" id="country-container">
                            <?php echo form_open_multipart('admin/escrow-managers/form/'.$user_id, array('class'=>'form-horizontal', 'id'=>'company_form')); ?>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="portlet light bordered">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                ...
                                                <span class="caption-subject bold font-yellow-casablanca uppercase"> Escrow Manager Details</span>
                                            </div>
                                        </div>
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <a href="<?php echo site_url('admin/escrow-managers');?>" class="btn default">Cancel</a>
                                    </div>
                                </div>
                            </div>
                            </form>
