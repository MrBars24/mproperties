    ...
    var handleProperty = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": base_url+"admin/Property/ajax/get_property_distribution", // ajax source
                    "data": {
