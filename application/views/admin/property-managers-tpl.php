...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            <h3 class="page-title">Property Managers</h3>
                ...
                <div class="col-md-12">
                    <div class="portlet">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-grid"></i>Property Managers
                            </div> 
                            <div class="actions">
                                <a href="<?php echo site_url('admin/property-managers/form/0');?>" class="btn default yellow-stripe">
                                <i class="fa fa-plus"></i>
                                <span class="hidden-480">
                                Add New Property Manager </span>
                                </a>                               
                            </div>                              
                        </div>
                    </div>
...
function deletePropertyManager(id)
{
    ...
    if (answer) {
        ...
        $.ajax({
            url: base_url + 'admin/property-managers/ajax/pmanager_delete',
            type: 'post',
            data: {
                "id": id,
            ...
            success: function (data) {
                ...
                location.replace(base_url + 'admin/property-managers')
            }
        })
    }
    else {
    ...
    var handleUsers = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": base_url+"admin/property-managers/ajax/get_all_users", // ajax source
                },
                "order": [
                    [0, "desc"]
