                ...
                <div class="col-md-12">
                    <div class="portlet">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-grid"></i>Property Listings
                            </div> 
                            <div class="actions">
                                <a href="<?php echo site_url('admin/property/form/0');?>" class="btn default yellow-stripe">
    ...
    var handleProperty = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": base_url+"admin/Property/ajax/get_all_properties", // ajax source
                },
                "order": [
                    [0, "desc"]
