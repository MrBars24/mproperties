...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            <h3 class="page-title">Real Estate Agents</h3>
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    <li>
                        ...
                        <a href="<?php echo site_url('/admin/users'); ?>">Real Estate Agents</a>
                ...
                <div class="col-md-12">
                    <div class="portlet">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-grid"></i>Real Estate Agents
                            </div> 
                            <div class="actions">
                                <a href="<?php echo site_url('admin/real-estate-agents/form/0');?>" class="btn default yellow-stripe">
                                <i class="fa fa-plus"></i>
                                <span class="hidden-480">
                                Add New Real Estate Agent</span>
                                </a>                               
                            </div>                              
                        </div>
                    </div>
...
function deletePropertyManager(id)
{
    ...
    if (answer) {
        ...
        $.ajax({
            url: base_url + 'admin/real-estate-agents/ajax/agent_delete',
            type: 'post',
            data: {
                "id": id,
            ...
            success: function (data) {
                ...
                location.replace(base_url + 'admin/real-estate-agents')
            }
        })
    }
    else {
    ...
    var handleUsers = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": base_url+"admin/real-estate-agents/ajax/get_all_users", // ajax source
                },
                "order": [
                    [0, "desc"]
