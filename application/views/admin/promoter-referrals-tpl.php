...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            <h3 class="page-title">Promoter Referrals</h3>
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    <li>
                        ...
                        <a href="<?php echo site_url('/admin/promoters'); ?>">Promoter Referrals</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <li>
                        <a href="#">Promoter Referrals</a>
                    </li>
                </ul>
            </div>
            <!-- END PAGE HEADER-->
                ...
                <div class="col-md-12">
                    <div class="portlet">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-grid"></i>Promoter Referrals
                            </div>
                            <!--div class="actions">
    ...
    var handleUsers = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": base_url+"admin/promoters/ajax/get_all_promoter_referrals", // ajax source
                    "data": {
