                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light bordered">
                        ...
                        <div class="portlet-body form" id="country-container">
                            <?php echo form_open_multipart('admin/transactions/order_form/'.$order_id, array('class'=>'form-horizontal', 'id'=>'company_form')); ?>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="portlet light bordered">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                ...
                                                <span class="caption-subject bold font-yellow-casablanca uppercase"> Order Details</span>
                                            </div>
                                        </div>
                                        <div class="portlet-body">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-2">Platform Fee Percentage <span class="required">
                                                    * </span>
                                                </label>

                                                <div class="col-md-4">
                                                    <input type="text" name="platform_fee_percentage" id="platform_fee_percentage" class="form-control"
                                                           data-required="1" value="<?php echo $platform_fee_percentage; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <a href="<?php echo site_url('admin/transactions/orders');?>" class="btn default">Cancel</a>
                                    </div>
                                </div>
                            </div>
                            </form>
