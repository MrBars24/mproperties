                ...
                <div class="col-md-12">
                    <div class="portlet">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-grid"></i>Admins
                            </div> 
                            <div class="actions">
                                <a href="<?php echo site_url('admin/admins/form/0');?>" class="btn default yellow-stripe">
                        ...
                        <div class="table-container">
                            <?php if($this->session->flashdata()): ?>
                                <?php foreach($this->session->flashdata() as $flashdata): ?>
                                    <div class="alert alert-success"><?php echo $flashdata; ?></div>
                                <?php endforeach; ?>
                            <?php endif; ?>
...
function deleteAdmin(id)
{
    ...
    if (answer) {
        ...
        $.ajax({
            url: base_url + 'admin/admins/ajax/admin_delete',
            type: 'post',
            data: {
                'id': id,
            ...
            success: function (data) {
                ...
                location.replace(base_url + 'admin/admins')
    ...
    var handleUsers = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": base_url+"admin/admins/ajax/get_all_users", // ajax source
                },
                "order": [
                    [0, "desc"]
