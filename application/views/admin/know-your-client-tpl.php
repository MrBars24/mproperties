...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            <h3 class="page-title">Know Your Clients</h3>
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    <li>
                        ...
                        <a href="<?php echo site_url('/admin/know-your-client'); ?>">Know Your Clients</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <li>
                        <a href="#">Know Your Clients</a>
                    </li>
                </ul>
            </div>
            <!-- END PAGE HEADER-->
                ...
                <div class="col-md-12">
                    <div class="portlet">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-grid"></i>Know Your Clients
                            </div> 
                            <div class="actions">
                                <a href="<?php echo site_url('admin/know-your-client/form/0');?>" class="btn default yellow-stripe">
                                <i class="fa fa-plus"></i>
                                <span class="hidden-480">
                                Add New Know Your Client</span>
                                </a>                               
                            </div>                              
                        </div>
                    </div>
...
$(document).on('click','.btn-delete',function(e){
    ...
    if (answer) {
        ...
        $.ajax({
            url: base_url + 'admin/know-your-client/ajax/kycmanager_delete',
            type: 'post',
            data: {
                "id": targetId,
            ...
            success: function (data) {
                console.log(data);
                location.replace(base_url + 'admin/know-your-client');
            }
        })
    }
});
    ...
    var handleUsers = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": base_url+"admin/know-your-client/ajax/get_all_users", // ajax source
                },
                "order": [
                    [0, "desc"]
