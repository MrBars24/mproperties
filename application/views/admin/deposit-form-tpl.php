                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-grid"></i>Deposit Detail
                            </div>
                        </div>
                        <div class="portlet-body form" id="country-container">
                            <?php echo form_open_multipart('admin/transactions/deposit_form/'.$id, array('class'=>'form-horizontal', 'id'=>'company_form')); ?>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="portlet light bordered">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                ...
                                                <span class="caption-subject bold font-yellow-casablanca uppercase"> Deposit Details</span>
                                            </div>
                                        </div>
                                        <div class="portlet-body">
                                            <div class="form-group">
                                                <label class="control-label col-md-2">Date of Deposit
                                                </label>
                                                <div class="col-md-4">
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <a href="<?php echo site_url('admin/transactions/deposits');?>" class="btn default">Cancel</a>
                                    </div>
                                </div>
                            </div>
                            </form>
