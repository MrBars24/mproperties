                ...
                <div class="col-md-12">
                    <div class="portlet">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-grid"></i>Content Managers
                            </div> 
                            <div class="actions">
                                <a href="<?php echo site_url('admin/content-managers/form/0');?>" class="btn default yellow-stripe">
                                <i class="fa fa-plus"></i>
                                <span class="hidden-480">
                                Add New Content Manager </span>
                                </a>                               
                            </div>                             
                        </div>
                    </div>
...
function deleteContentManager(id)
{
    ...
    if (answer) {
        ...
        $.ajax({
            url: base_url + 'admin/content-managers/ajax/cmanager_delete',
            type: 'post',
            data: {
                'id': id,
            ...
            success: function (data) {
                ...
                location.replace(base_url + 'admin/content-managers')
            }
        })
    }
    else {
    ...
    var handleUsers = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": base_url+"admin/content-managers/ajax/get_all_users", // ajax source
                },
                "order": [
                    [0, "desc"]
