            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    <li>
                        ...
                        <a href="<?php echo site_url('/admin/users'); ?>">Trades</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <li>
                        <a href="#">Trade Listings</a>
                    </li>
                </ul>
            </div>
            <!-- END PAGE HEADER-->
                ...
                <div class="col-md-12">
                    <div class="portlet">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-grid"></i>Trade Listings
                            </div>                           
                        </div>
                    </div>
                </div>
...
function deleteTrade(id)
{
    ...
    if (answer) {
        ...
        $.ajax({
            url: base_url + 'admin/transactions/ajax/trade_delete',
            type: 'post',
            data: {
                "id": id,
    ...
    var handleProperty = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": base_url+"admin/transactions/action/get_all_trades", // ajax source
                },
                "order": [
                    [0, "desc"]
