...
$config['smtp_user']        = 'no-reply@mymicroproperties.com';	//'mymicrop@mymicroproperties.com';
$config['smtp_pass']        = 'Letmpnoreplyin123!';		//'Z)2qMxZ7}eX5';
...
//$config['smtp_conn_options'] =  array('ssl' => array('verify_peer' => false,'verify_peer_name' => false,'allow_self_signed' => true));                 // SMTP connection options, an array passed to the function stream_context_create() when connecting via SMTP.
