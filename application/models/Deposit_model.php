...
class Deposit_model extends CI_Model {
	...
	public function get_all_deposits($user = false, $fname = false, $lname = false, $amount = false, $date_deposit = false, $date_approved = false, $status = false, $order_by = false){
		...
		$this->db->where('transaction_type', $this->config->item('funds_deposit'));
	...
	public function get_user_deposit($user_id, $amount = false, $ref_number = false, $date_deposit = false, $date_approved = false, $order_by = false){
		...
		if($order_by) $this->db->order_by($order_by);
		$this->db->where('status', $this->config->item("funds_deposit"));
	...
	{
		$deposit = $this->db->insert('fund_transactions', $data);
		return $deposit;
	}
}