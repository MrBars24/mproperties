...
class KnowYourClient extends CI_Controller {
    ...
    public function index() {
        ...
        $this->load->view('admin/know-your-client-tpl', $data);
    }
    ...
    */
    function form($user_id = false)
    {
        ...
        {
            $this->load->view('admin/know-your-client-form-tpl',$data);
            ...
            if ($user_id != 0) {
                ...
                $this->session->set_flashdata("kyc_updated", "KYC Updated");
                $this->ion_auth->update($user_id, $save_data);

            }else{

                $this->session->set_flashdata("kyc_added", "KYC Added");
            ...
            redirect('admin/know-your-client');
        }
    ...
    public function ajax($section){
        ...
        switch ($section) {
            ...
            case 'kycmanager_delete':
                $this->kycmanager_delete();
                break;
        }
    }
    ...
    protected function get_all_users()
    {
        ...
        $users = $this->Users_model->get_all_users($first_name, $last_name, $username, $email, false, false, $order_by, 8);
        ...
        for($i = $iDisplayStart; $i < $end; $i++) {
            ...
            $records["data"][] = array(
                ...
                '<a href="'.site_url("admin/know-your-client/form/".$user[$i]->user_id).'" class="btn btn-sm btn-circle btn-default btn-editable"><i class="fa fa-pencil"></i> Edit</a><a href="javascript:void(0);" class="btn btn-sm btn-circle btn-default btn-editable btn-delete" data-id="'.$user[$i]->user_id.'").">Delete</a>',
            );
        }
    ...
    protected function kycmanager_delete()
    {
